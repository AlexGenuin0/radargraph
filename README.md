...
<p>
    Para usar o programa, é importante baixar o dataset TAASRAD19. O link pra isso pode ser encontrado em <a href="#Mais-informações">Mais informações</a>. Todas as imagens ficarão salvas na pasta img, encontrada neste repositório. Nela, existem alguns gráficos feitos com versões mais antigas do código, para servir de exemplo.
</p>
